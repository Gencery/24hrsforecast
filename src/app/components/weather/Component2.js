...
export default function Component2() {
	...
	return (
		<div className="box ml-0 xl:ml-4 my-4 xl:my-0 p-4 space-y-2">
			...
			{/* Activities */}
			<div className="flex space-x-4 p-2 overflow-x-auto xl:max-w-[50vw] max-w-[100vw]">
				<a href="#" className="min-w-[100px] sm:min-w-[200px]">
					<img
